...
const ProfileInfo = () => {
  ...
  const handleUpdateJob = (e) => {
    ...
    dispatch(
      updateUserInfo(
        { work: [...user.work, { company, position }] },
        user._id,
        setJobShow
      )
    )
  ...
  const handleUpdateEdu = (e) => {
    e.preventDefault()
    dispatch(
      updateUserInfo({ edu: [...user.edu, { edu }] }, user._id, setEduShow)
    )
  }
  ...
  const handleUpdateUni = (e) => {
    e.preventDefault()
    dispatch(
      updateUserInfo({ uni: [...user.uni, { uni }] }, user._id, setUniShow)
    )
  }
  ...
  const handleCityAdd = (e) => {
    e.preventDefault()
    dispatch(
      updateUserInfo({ ...user, home_city: city }, user._id, setCityShow)
    )
  }
  ...
  const handleAddHomeTown = (e) => {
    e.preventDefault()
    dispatch(
      updateUserInfo({ ...user, home_town: town }, user._id, setTownShow)
    )
  }
        ...
        <div className="info-details-box">
          <ul>
            {user.cat && (
              <li>
                <img
                  src="https://static.xx.fbcdn.net/rsrc.php/v3/y5/r/VMZOiSIJIwn.png?_nc_eui2=AeHO54gLgP1p4qZ56c0suxPAysO07LK9kRPKw7Tssr2RE1O8Km0Ntd4u00hHeVUjva7I30yrCXQ6mKpl4EBw9TvE"
                  alt=""
                />
                <span> {user.cat} </span>
              </li>
            ...
            {user.work.map((data, index) => (
              <li key={index}>
                <img
                  src="https://static.xx.fbcdn.net/rsrc.php/v3/yp/r/Q9Qu4uLgzdm.png?_nc_eui2=AeEjnKVx7JEML4acw-YtOzo4QE0O-ZdJm-NATQ75l0mb4873d4pSYZV4yvmB8F oKDxLwCUBqTjyOrajqwOC9liP2"
                  alt=""
                />
                <span>
                  {' '}
                  {data.position} of{' '}
                  <div className="bold-text"> {data.company} </div>{' '}
                </span>
              </li>
            ))}
            ...
            {user.home_city && (
              <li>
                <img
                  src="https://static.xx.fbcdn.net/rsrc.php/v3/yc/r/-e1Al38ZrZL.png?_nc_eui2=AeH5RjTiXLUDp6NYfWo4HetjyuB9xaeJwC_K4H3Fp4nALwM4P-qVzUGg41q4cWyWXDkkD_OQwo6I5LibT7LJtk4J"
                  alt=""
                />
                <span>
                  {' '}
                  Lives in <div className="bold-text">
                    {user.home_city}
                  </div>{' '}
                </span>
              </li>
            ...
            {user.home_town && (
              <li>
                ...
                <span>
                  {' '}
                  From <div className="bold-text">{user.home_town}</div>{' '}
                </span>
              </li>
            )}
            ...
            <li>
              <img
                src="https://static.xx.fbcdn.net/rsrc.php/v3/yq/r/S0aTxIHuoYO.png?_nc_eui2=AeGzFeiXfu1DAFMwvznNRBP9rlG3yvH4CWGuUbfK8fgJYdEbOvOFOJSY777frC2826_rXGds6kWKxuTr2s2drikX"
                alt=""
              />
            ...
            <li>
              <img
                src="https://static.xx.fbcdn.net/rsrc.php/v3/yE/r/mp_faH0qhrY.png?_nc_eui2=AeHC84kGXC9JFqJsivr0xAianFrlaiZVSWecWuVqJlVJZ4mHylWIjnPUeIfJ3_KouPw3Kbh6WC3G8B6iNS1GUSw_"
                alt=""
              />
                  ...
                  {user.cat && !catShow && (
                    <div className="intro-item">
                      <div className="details">
                        <img
                          src="https://static.xx.fbcdn.net/rsrc.php/v3/yp/r/Q9Qu4uLgzdm.png?_nc_eui2=AeEjnKVx7JEML4acw-YtOzo4QE0O-ZdJm-NATQ75l0mb4873d4pSYZV4yvmB8FoKDxLwCUBqTjyOrajqwOC9liP2"
                          alt=""
                        />
                        <span> {user.cat} </span>
                      </div>
                  ...
                  {!catShow && !user.cat && (
                    <a href="/">
                      <div
                        style={{
                          backgroundImage:
                            'url(https://static.xx.fbcdn.net/rsrc.php/v3/y8/r/qDSwY9tayvO.png)',
                        }}
                    ...
                    <li className="work-box" key={index}>
                      <div className="intro-item">
                        <div className="details">
                          ...
                          <span>
                            {' '}
                            {data.position} of <strong>{data.company}</strong>{' '}
                          </span>
                        </div>
                        <div className="details-edit">
                          <div
                            style={{
                              backgroundImage:
                                'url(https://static.xx.fbcdn.net/rsrc.php/v3/y5/r/YQoVljLJSj5.png)',
                            }}
                      ...
                      <div className="intro-item">
                        ...
                        <div className="details-edit">
                          <div
                            ...
                            onClick={(e) => handleworkDelete(data.company)}
                            className="icon"
                          ></div>
                        </div>
                      </div>
                  ...
                  {user.home_city && (
                    ...
                    >
                      <div className="details">
                        ...
                        <span>
                          {' '}
                          Lives in <strong>{user.home_city}</strong>{' '}
                        </span>
                      </div>
                      <div className="details-edit">
                  ...
                  {user.home_town && !townShow && (
                    ...
                    >
                      <div className="details">
                        ...
                        <span>
                          {' '}
                          Lives in <strong>{user.home_town}</strong>{' '}
                        </span>
                      </div>
                      <div className="details-edit">
          ...
          <button onClick={() => setEditDetails(true)} className="edit-button">
            {' '}
            Edit details{' '}
          </button>
        </div>
          ...
          {featuredAddShow && (
            <FBmodal title={'Edit Featured'} closePopup={setFeaturedAddShow}>
              <div className="add-show-featured">
                <img src={baner} alt="" />
                <button onClick={() => setFeatureUpload(true)}>
                  {' '}
                  Add New{' '}
                </button>
              </div>
              ...
              <div className="featured-upload">
                              ...
                              <div className="round-check">
                                <label>
                                  <input
                                    ...
                                    type="checkbox"
                                    checked={featuredPhotosChecked.includes(
                                      item
                                    )}
                                    value={item.name}
                ...
                <div className="featured-upload-footer">
                  <button
                    ...
                    className="featured-cancel"
                  >
                    {' '}
                    Cancel{' '}
                  </button>
                  <button
                    onClick={() => setFeaturedPhotosNext(true)}
                ...
                <div className="featured-next">
                  ...
                  <div className="featured-collection-box">
                    <div className="featured-collection-item">
                      ...
                      {featuredPhotosChecked.map((item, index) => {
                        const pre_url = URL.createObjectURL(item)
                        return (
                          <>
                            <div className="upload-item" key={index}>
