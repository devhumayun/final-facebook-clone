...
const FullWidthPopupHeader = ({hide}) => {
  // get auth data
  const {user} = useSelector(state => state.auth);
  // state for user manu dropdown
  ...
  return (
    <>
        <div class="fb-home-header story-slider-header">
        <div class="fb-home-search">
          ...
          <div class="fb-home-user">
              ...
              <div class="fb-user-item" onClick={() => setUserMenu(!userMenu)}>
                {
                    userMenu &&
...
export default FullWidthPopupHeader